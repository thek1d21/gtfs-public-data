...
export const StatsPanel: React.FC<StatsPanelProps> = ({ 
  ...
  }, [stops, routes, calendar, trips, stopTimes, shapes]);
  ...
  const statsConfig = [
    ...
    {
      label: 'Interchanges',
      value: stats.interchanges.toLocaleString(),
      icon: Navigation,
    ...
    },
    {
      ...
      value: `${stats.accessibilityPercentage}%`,
      icon: Accessibility,
    ...
    {
      label: 'Route Shapes',
      value: stats.totalShapes.toLocaleString(),
      icon: Navigation,
